...
import com.threedee.mobile_ui.databinding.LayoutFragmentThreeBinding
...
class OnboardingFragmentThree : DaggerFragment() {

    lateinit var binding: LayoutFragmentThreeBinding
    @Inject
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.layout_fragment_three, container, false)
        return binding.root
    }
